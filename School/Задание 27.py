...
# ЕГКР 19.04 В1
"""В ответе запишите четыре числа: в первой строке - сначала
абсолютное значение целой части произведения Px * 10_000, затем
абсолютное значение целой части произведения Py * 10_000
"""
"""from math import dist
...
print(px, py)
# A: -32678.472167372413 29156.95571286656
# B: -31457.282853316807 14113.766704351337
# Wrong:
# A: 32678 29156
# B: 31457 14113
# При отрицательном
# Целая часть берется следующее отрицательное
# Correct:
# 32679 29156
# 31458 14113"""
